...
---
# Backups
The Platform performs automated backups that ran regularly both on [Google Cloud](https://cloud.google.com) and [Amazon Web Services](https://aws.amazon.com) to protect internal and users' data from loss.
...
# DDoS Protection
The Platform uses [Cloudflare](https://cloudflare.com) to mitigates against DDoS attacks.